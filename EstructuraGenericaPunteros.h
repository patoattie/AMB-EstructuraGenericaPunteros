#ifndef ESTRUCTURAGENERICAPUNTEROS_H_INCLUDED
#define ESTRUCTURAGENERICAPUNTEROS_H_INCLUDED
...
int eGen_buscarLugarLibre(eGenerica*, int limite);
...
#endif // ESTRUCTURAGENERICAPUNTEROS_H_INCLUDED
